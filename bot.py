...
async def start(event):
  await event.reply("**TTK Tagger Bot**, Qrup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Məni Bir Qruba Ekle', 'https://t.me/TTKtaggerbot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/RiyaddBlogg'),
...
print(">> Bot çalıyor merak etme 🚀 @RiyadAndMe bilgi alabilirsin <<")
